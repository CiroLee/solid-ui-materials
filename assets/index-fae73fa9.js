...
`,O=r("<div flex items-center justify-between><h3>STextarea</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),R=r("<p text-sub>depend on "),V=r("<h4>basic"),B=r("<h4>custom rows"),F=r("<h4>resize set"),k=r("<div children:mb-3>"),G=r("<h4>allow clear"),J=r("<h4>show count"),K=r("<h4>status");function W(){const s=[{name:"index.tsx",path:"components/STextarea/index.tsx"},{name:"index.scss",path:"components/STextarea/index.scss"}],[g,i]=u(""),[x,c]=u(""),[t,l]=u(!1);return[(()=>{const n=O(),h=n.firstChild,j=h.nextSibling,d=j.firstChild;return d.$$click=()=>l(!0),e(j,a(T,{path:"STextarea",name:"source"}),null),n})(),(()=>{const n=R();return n.firstChild,e(n,a(C,{class:"text-blue-600",href:"/components/icon",children:"SIcon"}),null),n})(),V(),a(p,{class:"w-600px",placeholder:"input sth"}),a(o,{content:D}),B(),a(p,{class:"w-600px",placeholder:"rows=3",rows:3}),a(o,{content:E}),F(),(()=>{const n=k();return e(n,a(p,{class:"w-600px",placeholder:"resize default(both)"}),null),e(n,a(p,{class:"w-600px",resize:"vertical",placeholder:"resize vertical"}),null),e(n,a(p,{class:"w-600px",resize:"horizontal",placeholder:"resize horizontal"}),null),e(n,a(p,{class:"w-600px",resize:"none",placeholder:"disabled resize"}),null),n})(),a(o,{content:I}),G(),a(p,{class:"w-600px",clearable:!0,get value(){return g()},onChange:i}),a(o,{content:P}),J(),a(p,{class:"w-600px",showCount:!0,get value(){return x()},onChange:c,clearable:!0,maxLength:100}),a(o,{content:H}),K(),(()=>{const n=k();return e(n,a(p,{class:"w-600px",placeholder:"warn",status:"warn"}),null),e(n,a(p,{class:"w-600px",placeholder:"error",status:"error"}),null),e(n,a(p,{class:"w-600px",placeholder:"disabled",disabled:!0}),null),e(n,a(p,{class:"w-600px",placeholder:"readonly",readonly:!0,value:"readonly"}),null),n})(),a(o,{content:N}),a(b,{get show(){return t()},tabs:s,onCancel:()=>l(!1)})]}f(["click"]);export{W as default};
