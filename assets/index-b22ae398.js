import{m as j,a as m,b as u,s as d,t as c,d as g,i as l,c as n,e as _}from"./index-4dbdb587.js";import{S as k,C as y,a as v}from"./index-4a63075d.js";const S=c("<div>"),f=h=>{const p=j({type:"flicker",class:"",style:{}},h);return(()=>{const t=S();return m(s=>{const a=`s-skeleton  s-skeleton--${p.type} ${p.class}`.replace(/\s{2,}/g," ").trim(),r=p.style;return a!==s._v$&&u(t,s._v$=a),s._v$2=d(t,r,s._v$2),s},{_v$:void 0,_v$2:void 0}),t})()},e=f,q=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`;const x=c("<div flex items-center justify-between><h3>SSkeleton</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),b=c("<h4>type: shimmer"),o=c('<div class="card-skeleton"><div class="card-skeleton__content">'),w=c("<h4>type: flicker");function z(){const h=[{name:"index.tsx",path:"components/SSkeleton/index.tsx"},{name:"index.scss",path:"components/SSkeleton/index.scss"}],[p,t]=g(!1);return[(()=>{const s=x(),a=s.firstChild,r=a.nextSibling,i=r.firstChild;return i.$$click=()=>t(!0),l(r,n(k,{path:"SSkeleton",name:"source"}),null),s})(),b(),(()=>{const s=o(),a=s.firstChild;return l(s,n(e,{type:"shimmer",class:"card-skeleton__avatar"}),a),l(a,n(e,{type:"shimmer",class:"card-skeleton__item"}),null),l(a,n(e,{type:"shimmer",class:"card-skeleton__item",style:{width:"80%"}}),null),s})(),w(),(()=>{const s=o(),a=s.firstChild;return l(s,n(e,{type:"flicker",class:"card-skeleton__avatar"}),a),l(a,n(e,{type:"flicker",class:"card-skeleton__item"}),null),l(a,n(e,{type:"flicker",class:"card-skeleton__item",style:{width:"80%"}}),null),s})(),n(y,{content:q}),n(v,{get show(){return p()},tabs:h,onCancel:()=>t(!1)})]}_(["click"]);export{z as default};
