import{d as c,i as n,c as a,a as b,b as y,t as e,e as w}from"./index-36404f30.js";import{S as t,C as S,b as k,a as B}from"./index-34052f2b.js";import{S as C}from"./index-17948319.js";import{S as _}from"./index-d00e4d04.js";const P=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`;const $=e("<div flex items-center justify-between><h3>SPopup</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),v=e("<p text-sub text-14px>The popup component is the basis for other popup-like components for full-screen popups, such as Modal, Drawer, etc."),q=e("<div flex items-center mb-3><span ml-3>isBlur: "),D=e("<div children:mr-3>"),A=e("<div>popup content");function N(){const u=[{name:"index.tsx",path:"components/SPopup/index.tsx"},{name:"index.scss",path:"components/SPopup/index.scss"}],[m,o]=c(!1),[r,g]=c(!0),[d,h]=c(!1),[i,x]=c("left"),l=s=>{h(!0),x(s)};return[(()=>{const s=$(),p=s.firstChild,j=p.nextSibling,f=j.firstChild;return f.$$click=()=>o(!0),n(j,a(_,{path:"SPopup",name:"source"}),null),s})(),v(),(()=>{const s=q(),p=s.firstChild;return p.firstChild,n(s,a(C,{get checked(){return r()},onChange:g}),p),n(p,()=>r()?"true":"false",null),s})(),(()=>{const s=D();return n(s,a(t,{type:"primary",onClick:()=>l("left"),children:"left"}),null),n(s,a(t,{type:"primary",onClick:()=>l("right"),children:"right"}),null),n(s,a(t,{type:"primary",onClick:()=>l("top"),children:"top"}),null),n(s,a(t,{type:"primary",onClick:()=>l("bottom"),children:"bottom"}),null),n(s,a(t,{type:"primary",onClick:()=>l("center"),children:"center"}),null),s})(),a(S,{content:P}),a(k,{get show(){return d()},maskClosable:!0,get placement(){return i()},get isBlur(){return r()},onCancel:()=>h(!1),get children(){const s=A();return b(()=>y(s,`popup-box popup-box--${i()}`)),s}}),a(B,{get show(){return m()},tabs:u,onCancel:()=>o(!1)})]}w(["click"]);export{N as default};
