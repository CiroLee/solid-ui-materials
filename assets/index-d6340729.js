import{m as S,d as i,f as V,i as t,c as a,S as L,M as g,I as h,g as B,a as C,b as P,s as W,h as b,e as z,t as p,A as D}from"./index-bf3dde8f.js";import{S as E,C as o,a as M}from"./index-41233d97.js";const H=p('<div class="s-input__prefix">'),N=p('<div class="s-input__suffix">'),A=p('<div class="s-input__suffix s-input__clear">'),O=p('<span class="s-input__suffix s-input__count">'),R=p("<div><input>"),T=l=>{const r=S({size:"medium",countWidth:"0px",class:"",style:{}},l),[m,d]=i(""),[u,y]=i(!0),f=()=>l.type==="password"?u()?"password":"text":l.type||"text",x=c=>{const s=c.target;if(l.maxLength&&s.value.length>l.maxLength){s.value=s.value.slice(0,l.maxLength);return}l.onChange&&l.onChange(s.value)};return V(()=>{l.showCount&&(l.maxLength?d(`${l.value?.length}/${l.maxLength}`):d(`${l.value?.length}`))}),(()=>{const c=R(),s=c.firstChild;return t(c,a(L,{get when(){return l.prefix},get children(){const n=H();return t(n,()=>l.prefix),n}}),s),s.$$input=x,t(c,a(B,{get children(){return[a(g,{get when(){return l.suffix},get children(){const n=N();return t(n,()=>l.suffix),n}}),a(g,{get when(){return l.clearable&&l.value},get children(){const n=A();return n.$$click=()=>l.onChange?.(""),t(n,a(h,{name:"close-circle-fill"})),n}}),a(g,{get when(){return l.showCount},get children(){const n=O();return t(n,m),n}}),a(g,{get when(){return l.type==="password"},get children(){const n=A();return n.$$click=()=>y(!u()),t(n,a(h,{get name(){return`${u()?"eye-close-line":"eye-line"}`}})),n}})]}}),null),C(n=>{const j=`s-input s-input--${r.size} ${r.status?`s-input--${r.status}`:""} 
      ${r.class}`.replace(/\s{2,}/g," ").trim(),w={...r.style,"--count-width":r.countWidth},v=f(),$=l.disabled,q=l.readonly,I=l.placeholder;return j!==n._v$&&P(c,n._v$=j),n._v$2=W(c,w,n._v$2),v!==n._v$3&&b(s,"type",n._v$3=v),$!==n._v$4&&(s.disabled=n._v$4=$),q!==n._v$5&&(s.readOnly=n._v$5=q),I!==n._v$6&&b(s,"placeholder",n._v$6=I),n},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),C(()=>s.value=l.value||""),c})()},e=T;z(["input","click"]);const F=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Input</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path&#x27;</span>;
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  ...
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">value</span>=<span class="hljs-string">{value()}</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;input sth...&quot;</span> <span class="hljs-attr">onChange</span>=<span class="hljs-string">{setValue}</span> /&gt;</span>
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;prefix icon&quot;</span> <span class="hljs-attr">prefix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;user-line&quot;</span> <span class="hljs-attr">color</span>=<span class="hljs-string">&quot;gray&quot;</span> /&gt;</span>} /&gt;
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;suffix icon&quot;</span> <span class="hljs-attr">suffix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;search-line&quot;</span> <span class="hljs-attr">color</span>=<span class="hljs-string">&quot;gray&quot;</span> /&gt;</span>} /&gt;
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span>
        <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;suffix icon&quot;</span>
        <span class="hljs-attr">prefix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;money-cny-box-line&quot;</span> <span class="hljs-attr">color</span>=<span class="hljs-string">&quot;gray&quot;</span> /&gt;</span>}
        suffix={<span class="hljs-tag">&lt;<span class="hljs-name">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;information-line&quot;</span> <span class="hljs-attr">color</span>=<span class="hljs-string">&quot;#b9b5b5&quot;</span> <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;information&quot;</span> /&gt;</span>}
      /&gt;
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">status</span>=<span class="hljs-string">&quot;warn&quot;</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;warn&quot;</span> <span class="hljs-attr">prefix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;shield-keyhole-line&quot;</span> /&gt;</span>} /&gt;
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">status</span>=<span class="hljs-string">&quot;error&quot;</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">&quot;error&quot;</span> <span class="hljs-attr">prefix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;shield-keyhole-line&quot;</span> /&gt;</span>} /&gt;
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span>
        ...
        <span class="hljs-attr">prefix</span>=<span class="hljs-string">{</span>&lt;<span class="hljs-attr">Icon</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;shield-keyhole-line&quot;</span> <span class="hljs-attr">color</span>=<span class="hljs-string">&quot;#BABABA&quot;</span> /&gt;</span>}
      /&gt;
      <span class="hljs-tag">&lt;<span class="hljs-name">Input</span> <span class="hljs-attr">readonly</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;readonly&quot;</span> /&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
