import{m as b,i as n,c as x,a as k,s as S,e as m,t as p,b as w,d as a,S as u}from"./index-5be74f38.js";import{S as _,C as r,a as B}from"./index-1cb8ebd7.js";const q=p('<button tabindex="0">'),f=e=>{const c=b({size:"medium",type:"default",class:"",style:{}},e),o=()=>{e.onClick&&e.onClick()};return(()=>{const s=q();return s.$$click=o,n(s,()=>e.children),x(t=>{const h=e.disabled,j=`s-button s-button--${c.size} s-button--${c.type}
