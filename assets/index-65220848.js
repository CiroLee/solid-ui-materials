import{m as y,i as n,c as a,S as g,g as j,a as w,b as x,s as q,t as e,d as f,A as _,e as k}from"./index-10b63f6b.js";import{S as $}from"./index-d592343d.js";import{C as i,a as S}from"./index-2d172113.js";import{S as A}from"./index-2583c958.js";const v=e('<div class="s-alert__title">'),b=e('<div><div class="s-alert__content"><div class="s-alert__description">'),C=h=>{const l=y({type:"info",class:"",style:{}},h),o=()=>({info:"information-fill",success:"checkbox-circle-fill",warn:"information-fill",error:"close-circle-fill"})[l.type];return(()=>{const s=b(),c=s.firstChild,r=c.firstChild;return n(s,a(j,{get when(){return l.showIcon},get children(){return a(g,{get name(){return o()},size:"24px",class:"s-alert__prefix"})}}),c),n(c,a(j,{get when(){return l.title},get children(){const t=v();return n(t,()=>l.title),t}}),r),n(r,()=>l.description),n(s,a(j,{get when(){return l.action},get children(){return l.action}}),null),w(t=>{const d=`s-alert s-alert--${l.type} ${l.class}`.replace(/\s{2,}/g," ").trim(),m=l.style;return d!==t._v$&&x(s,t._v$=d),t._v$2=q(s,m,t._v$2),t},{_v$:void 0,_v$2:void 0}),s})()},p=C,I=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
