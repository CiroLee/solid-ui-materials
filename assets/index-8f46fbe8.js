import{m as y,i as a,c as n,S as g,g as j,a as w,b as q,s as f,t as e,d as x,A as _,e as k}from"./index-9076e8e0.js";import{S}from"./index-e838c20a.js";import{S as $,C as i,a as A}from"./index-f29ba76b.js";const v=e('<div class="s-alert__title">'),b=e('<div><div class="s-alert__content"><div class="s-alert__description">'),C=h=>{const t=y({type:"info",class:"",style:{}},h),o=()=>({info:"information-fill",success:"checkbox-circle-fill",warn:"information-fill",error:"close-circle-fill"})[t.type];return(()=>{const s=b(),c=s.firstChild,r=c.firstChild;return a(s,n(j,{get when(){return t.showIcon},get children(){return n(g,{get name(){return o()},size:"24px",class:"s-alert__prefix"})}}),c),a(c,n(j,{get when(){return t.title},get children(){const p=v();return a(p,()=>t.title),p}}),r),a(r,()=>t.description),a(s,n(j,{get when(){return t.action},get children(){return t.action}}),null),w(p=>{const d=`s-alert s-alert--${t.type} ${t.class}`.replace(/\s{2,}/g," ").trim(),m=t.style;return d!==p._v$&&q(s,p._v$=d),p._v$2=f(s,m,p._v$2),p},{_v$:void 0,_v$2:void 0}),s})()},l=C,I=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
