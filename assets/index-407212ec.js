import{d as i,i as n,c as a,t as p,e as w}from"./index-d97918cf.js";import{S as u}from"./index-8724e060.js";import{S as l}from"./index-3260429e.js";import{C as h,a as S}from"./index-ad32141b.js";const y=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`,x=p("<div flex items-center justify-between><h3>SSwitch</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),_=p("<h4>basic"),$=p("<div><p>switch: <!> "),C=p("<h4>size"),j=p('<div class="children:mb-2 children:flex!">'),b=p("<h4>disabled");function A(){const d=[{name:"tsx",path:"components/SSwitch/index.tsx"},{name:"scss",path:"components/SSwitch/index.scss"}],[m,r]=i(!1),[o,g]=i(!1);return[(()=>{const s=x(),t=s.firstChild,e=t.nextSibling,c=e.firstChild;return c.$$click=()=>r(!0),n(e,a(u,{path:"SSwitch",name:"source"}),null),s})(),_(),(()=>{const s=$(),t=s.firstChild,e=t.firstChild,c=e.nextSibling;return c.nextSibling,n(t,()=>o()?"On":"Off",c),n(s,a(l,{get checked(){return o()},onChange:g}),null),s})(),a(h,{content:y}),C(),(()=>{const s=j();return n(s,a(l,{size:"small"}),null),n(s,a(l,{size:"medium"}),null),n(s,a(l,{size:"large"}),null),s})(),a(h,{content:k}),b(),(()=>{const s=j();return n(s,a(l,{checked:!0,disabled:!0}),null),n(s,a(l,{disabled:!0}),null),s})(),a(h,{content:f}),a(S,{get show(){return m()},tabs:d,onCancel:()=>r(!1)})]}w(["click"]);export{A as default};
