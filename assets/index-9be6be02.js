import{m as j,a as m,b as u,s as d,t as c,d as g,i as l,c as n,e as _}from"./index-02899d5b.js";import{S as k}from"./index-43b5ab94.js";import{C as y,a as v}from"./index-3a3248a1.js";const f=c("<div>"),S=h=>{const e=j({type:"flicker",class:"",style:{}},h);return(()=>{const t=f();return m(s=>{const a=`s-skeleton  s-skeleton--${e.type} ${e.class}`.replace(/\s{2,}/g," ").trim(),r=e.style;return a!==s._v$&&u(t,s._v$=a),s._v$2=d(t,r,s._v$2),s},{_v$:void 0,_v$2:void 0}),t})()},p=S,q=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`;const b=c("<div flex items-center justify-between><h3>SSkeleton</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),x=c("<h4>type: shimmer"),o=c('<div class="card-skeleton"><div class="card-skeleton__content">'),w=c("<h4>type: flicker");function D(){const h=[{name:"tsx",path:"components/SSkeleton/index.tsx"},{name:"scss",path:"components/SSkeleton/index.scss"}],[e,t]=g(!1);return[(()=>{const s=b(),a=s.firstChild,r=a.nextSibling,i=r.firstChild;return i.$$click=()=>t(!0),l(r,n(k,{path:"SSkeleton",name:"source"}),null),s})(),x(),(()=>{const s=o(),a=s.firstChild;return l(s,n(p,{type:"shimmer",class:"card-skeleton__avatar"}),a),l(a,n(p,{type:"shimmer",class:"card-skeleton__item"}),null),l(a,n(p,{type:"shimmer",class:"card-skeleton__item",style:{width:"80%"}}),null),s})(),w(),(()=>{const s=o(),a=s.firstChild;return l(s,n(p,{type:"flicker",class:"card-skeleton__avatar"}),a),l(a,n(p,{type:"flicker",class:"card-skeleton__item"}),null),l(a,n(p,{type:"flicker",class:"card-skeleton__item",style:{width:"80%"}}),null),s})(),n(y,{content:q}),n(v,{get show(){return e()},tabs:h,onCancel:()=>t(!1)})]}_(["click"]);export{D as default};
