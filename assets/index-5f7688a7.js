import{m as g,i as r,a as u,b as k,s as v,t,f as _,c as p,F as y,d as C,e as w}from"./index-bf3dde8f.js";import{S as $,C as j,a as f}from"./index-41233d97.js";const q=t('<label><input type="checkbox"><div class="s-checkbox__track"></div><div class="s-checkbox__children">'),G=o=>{const a=g({class:"",style:{}},o),e=c=>{o.onChange?.(c)};return(()=>{const c=q(),n=c.firstChild,s=n.nextSibling,h=s.nextSibling;return n.addEventListener("change",e),r(h,()=>a.children),u(l=>{const i=`s-checkbox ${a.class}`.replace(/\s{2,}/g," ").trim(),b=a.style,x=a.disabled;return i!==l._v$&&k(c,l._v$=i),l._v$2=v(c,b,l._v$2),x!==l._v$3&&(n.disabled=l._v$3=x),l},{_v$:void 0,_v$2:void 0,_v$3:void 0}),u(()=>n.checked=a.checked),c})()},d=G,A=t("<div>"),S=o=>{let a=[];const e=g({class:"",value:"",style:{}},o),c=(n,s)=>{a=n.currentTarget.checked?[...a,s]:a.filter(l=>l!==s),o.onChange?.(a)};return _(()=>{a=[...a,e.value]}),(()=>{const n=A();return r(n,p(y,{get each(){return e.options},children:s=>p(d,g(s,{get checked(){return s.value===e.value},onChange:h=>c(h,s.value)}))})),u(s=>{const h=`s-checkbox-group ${e.class}`.replace(/\s{2,}/g," ").trim(),l=e.style;return h!==s._v$&&k(n,s._v$=h),s._v$2=v(n,l,s._v$2),s},{_v$:void 0,_v$2:void 0}),n})()},m=S,E=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Checkbox</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path&#x27;</span>;
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">Checkbox</span> <span class="hljs-attr">onChange</span>=<span class="hljs-string">{(e)</span> =&gt;</span> console.log(e)}&gt;checkbox<span class="hljs-tag">&lt;/<span class="hljs-name">Checkbox</span>&gt;</span></span>;
};
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">Checkbox</span> <span class="hljs-attr">disabled</span> <span class="hljs-attr">checked</span>&gt;</span>
        disabled
...
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Radio</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">CheckboxGroupOptions</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path&#x27;</span>;
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">const</span> <span class="hljs-attr">checkboxGroup</span>: <span class="hljs-title class_">CheckboxGroupOptions</span>[] = [
    {
  ...
  <span class="hljs-keyword">return</span> <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">CheckboxGroup</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;apple&quot;</span> <span class="hljs-attr">options</span>=<span class="hljs-string">{checkboxGroup}</span> <span class="hljs-attr">onChange</span>=<span class="hljs-string">{(list)</span> =&gt;</span> console.log(list)} /&gt;</span>;
};
