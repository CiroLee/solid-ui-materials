import{m as z,b as i,f as V,g as L,i as t,d as a,h as d,S as r,c as C,a as B,s as P,j as I,e as A,t as p,A as D}from"./index-5be74f38.js";import{S as E,C as h,a as W}from"./index-1cb8ebd7.js";const H=p('<div class="s-input__prefix">'),M=p('<div class="s-input__suffix">'),b=p('<div class="s-input__suffix s-input__clear">'),N=p('<span class="s-input__suffix s-input__count">'),O=p("<div><input>"),R=l=>{const o=z({size:"medium",class:"",style:{}},l),[m,g]=i(""),[u,y]=i(!0),f=V(()=>l.type==="password"?u()?"password":"text":l.type||"text"),x=e=>{const s=e.target;if(l.maxLength&&s.value.length>l.maxLength){s.value=s.value.slice(0,l.maxLength);return}l.onChange&&l.onChange(s.value)};return L(()=>{l.showCount&&(l.maxLength?g(`${l.value?.length}/${l.maxLength}`):g(`${l.value?.length}`))}),(()=>{const e=O(),s=e.firstChild;return t(e,a(d,{get when(){return l.prefix},get children(){const n=H();return t(n,()=>l.prefix),n}}),s),s.$$input=x,t(e,a(d,{get when(){return l.suffix},get children(){const n=M();return t(n,()=>l.suffix),n}}),null),t(e,a(d,{get when(){return l.clearable&&l.value},get children(){const n=b();return n.$$click=()=>l.onChange?.(""),t(n,a(r,{name:"close-circle-fill"})),n}}),null),t(e,a(d,{get when(){return l.showCount},get children(){const n=N();return t(n,m),n}}),null),t(e,a(d,{get when(){return l.type==="password"},get children(){const n=b();return n.$$click=()=>y(!u()),t(n,a(r,{get name(){return`${u()?"eye-close-line":"eye-line"}`}})),n}}),null),C(n=>{const j=`s-input s-input--${o.size} ${o.status?`s-input--${o.status}`:""} 
