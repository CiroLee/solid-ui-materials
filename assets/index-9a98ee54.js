import{m as v,i as n,c as a,M as u,a as d,h as m,g as x,b as y,s as f,t as p,d as _,e as w}from"./index-2c494481.js";import{S as k,C as o,a as q}from"./index-d4fca61e.js";const A=p('<div class="s-avatar s-avatar__default">'),$=p('<img class="s-avatar__img">'),b=p('<div class="s-avatar__text">'),C=p("<div>");function z(){return A()}const U=i=>{const r=v({size:"medium",shape:"circle",class:"",alt:"img",style:{}},i);return(()=>{const h=C();return n(h,a(x,{get fallback(){return a(z,{})},get children(){return[a(u,{get when(){return r.src},get children(){const s=$();return d(t=>{const c=r.src,j=r.alt;return c!==t._v$&&m(s,"src",t._v$=c),j!==t._v$2&&m(s,"alt",t._v$2=j),t},{_v$:void 0,_v$2:void 0}),s}}),a(u,{get when(){return r.text},get children(){const s=b();return n(s,()=>r.text),s}})]}})),d(s=>{const t=`s-avatar s-avatar--${r.size} s-avatar--${r.shape} ${r.class}`.replace(/\s{2,}/g," ").trim(),c=r.style;return t!==s._v$3&&y(h,s._v$3=t),s._v$4=f(h,c,s._v$4),s},{_v$3:void 0,_v$4:void 0}),h})()},l=U,P=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Avatar</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path&#x27;</span>;
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;large&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;medium&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;tiny&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
...
`,S=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Avatar</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;your path&#x27;</span>;
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;circle&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;square&quot;</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;small&quot;</span> <span class="hljs-attr">text</span>=<span class="hljs-string">&quot;A&quot;</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">text</span>=<span class="hljs-string">&quot;A&quot;</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;large&quot;</span> <span class="hljs-attr">text</span>=<span class="hljs-string">&quot;A&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">{{</span> <span class="hljs-attr">color:</span> &#x27;#<span class="hljs-attr">fff</span>&#x27;, &#x27;<span class="hljs-attr">background-color</span>&#x27;<span class="hljs-attr">:</span> &#x27;#<span class="hljs-attr">FF7817</span>&#x27; }} /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;large&quot;</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;square&quot;</span> <span class="hljs-attr">text</span>=<span class="hljs-string">&quot;A&quot;</span> <span class="hljs-attr">style</span>=<span class="hljs-string">{{</span> <span class="hljs-attr">color:</span> &#x27;#<span class="hljs-attr">fff</span>&#x27;, &#x27;<span class="hljs-attr">background-color</span>&#x27;<span class="hljs-attr">:</span> &#x27;#<span class="hljs-attr">42C421</span>&#x27; }} /&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;avatar-group&quot;</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">src</span>=<span class="hljs-string">{avatarUrl}</span> /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">Avatar</span> <span class="hljs-attr">text</span>=<span class="hljs-string">&quot;+3&quot;</span> /&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
...
`;const M=p("<div flex items-center justify-between><h3>Avatar</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),L=p("<h4>size"),g=p('<div class="flex items-center children:mr-3">'),N=p("<h4>shape"),R=p("<h4>text avatar"),V=p("<h4>usage - avatar group"),B=p('<div class="avatar-group">'),G=p("<h4>usage- online/offline"),H=p('<div class="flex children:mr-3"><div class="avatar-status online"><div class="dot dot--online"></div></div><div class="avatar-status offline"><div class="dot dot--online">'),e="https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200";function K(){const i=[{name:"index.tsx",path:"components/Avatar/index.tsx"},{name:"index.scss",path:"components/Avatar/index.scss"}],[r,h]=_(!1);return[(()=>{const s=M(),t=s.firstChild,c=t.nextSibling,j=c.firstChild;return j.$$click=()=>h(!0),n(c,a(k,{path:"Avatar",name:"source"}),null),s})(),L(),(()=>{const s=g();return n(s,a(l,{size:"large"}),null),n(s,a(l,{size:"large",src:e}),null),n(s,a(l,{size:"medium",src:e}),null),n(s,a(l,{size:"small",src:e}),null),n(s,a(l,{size:"tiny",src:e}),null),s})(),a(o,{content:P}),N(),(()=>{const s=g();return n(s,a(l,{shape:"circle",src:e}),null),n(s,a(l,{shape:"square",src:e}),null),s})(),a(o,{content:S}),R(),(()=>{const s=g();return n(s,a(l,{size:"small",text:"A"}),null),n(s,a(l,{text:"A"}),null),n(s,a(l,{size:"large",text:"A",style:{color:"#fff","background-color":"#FF7817"}}),null),n(s,a(l,{size:"large",shape:"square",text:"A",style:{color:"#fff","background-color":"#42C421"}}),null),s})(),a(o,{content:D}),V(),(()=>{const s=B();return n(s,a(l,{src:e}),null),n(s,a(l,{src:e}),null),n(s,a(l,{src:e}),null),n(s,a(l,{text:"+3"}),null),s})(),a(o,{content:F}),G(),(()=>{const s=H(),t=s.firstChild;t.firstChild;const c=t.nextSibling;return c.firstChild,t.style.setProperty("width","40px"),t.style.setProperty("height","40px"),n(t,a(l,{shape:"circle",src:e}),null),c.style.setProperty("width","40px"),c.style.setProperty("height","40px"),n(c,a(l,{shape:"circle",src:e}),null),s})(),a(o,{content:E}),a(q,{get show(){return r()},tabs:i,onCancel:()=>h(!1)})]}w(["click"]);export{K as default};
