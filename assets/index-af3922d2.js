...
`,K=t("<div flex items-center justify-between><h3>SInput</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),Q=t("<p text-gray>depend on "),U=t("<h4>基本使用"),X=t("<div w-540px><p>value: "),Y=t("<h4>不同尺寸"),_=t("<div w-540px children:mb-3>"),Z=t("<h4>前缀和后缀"),ss=t("<h4>不同状态"),as=t("<h4>可清除"),v=t("<div w-540px>"),ns=t("<h4>显示计数"),ls=t("<h4>密码");function es(){const n=[{name:"tsx",path:"components/SInput/index.tsx"},{name:"scss",path:"components/SInput/index.scss"}],[g,m]=u(""),[j,f]=u(""),[x,w]=u(""),[e,p]=u(!1);return[(()=>{const s=K(),h=s.firstChild,i=h.nextSibling,y=i.firstChild;return y.$$click=()=>p(!0),l(i,a(B,{path:"SIcon",name:"source"}),null),s})(),(()=>{const s=Q();return s.firstChild,l(s,a(L,{class:"text-blue decoration-none",activeClass:"text-blue-600",inactiveClass:"text-blue-600",href:"/components/icon",children:"SIcon"}),null),s})(),U(),(()=>{const s=X(),h=s.firstChild;return h.firstChild,l(h,g,null),l(s,a(c,{get value(){return g()},placeholder:"input sth...",onChange:m}),null),s})(),a(o,{content:N}),Y(),(()=>{const s=_();return l(s,a(c,{size:"small",placeholder:"small size"}),null),l(s,a(c,{size:"medium",placeholder:"medium size"}),null),l(s,a(c,{size:"large",placeholder:"large size"}),null),s})(),a(o,{content:O}),Z(),(()=>{const s=_();return l(s,a(c,{placeholder:"prefix icon",get prefix(){return a(r,{name:"user-line",color:"gray"})}}),null),l(s,a(c,{placeholder:"suffix icon",get suffix(){return a(r,{name:"search-line",color:"gray"})}}),null),l(s,a(c,{placeholder:"suffix icon",get prefix(){return a(r,{name:"money-cny-box-line",color:"gray"})},get suffix(){return a(r,{name:"information-line",color:"#b9b5b5",title:"information"})}}),null),s})(),a(o,{content:R}),ss(),(()=>{const s=_();return l(s,a(c,{status:"warn",placeholder:"warn",get prefix(){return a(r,{name:"shield-keyhole-line"})}}),null),l(s,a(c,{status:"error",placeholder:"error",get prefix(){return a(r,{name:"shield-keyhole-line"})}}),null),l(s,a(c,{disabled:!0,placeholder:"disabled",status:"error",value:"disabled",get prefix(){return a(r,{name:"shield-keyhole-line",color:"#BABABA"})}}),null),l(s,a(c,{readonly:!0,value:"readonly"}),null),s})(),a(o,{content:T}),as(),(()=>{const s=v();return l(s,a(c,{clearable:!0,placeholder:"input sth...",get value(){return j()},onChange:f})),s})(),a(o,{content:F}),ns(),(()=>{const s=v();return l(s,a(c,{showCount:!0,placeholder:"input sth...",maxLength:20,countWidth:"40px",get value(){return x()},onChange:w})),s})(),a(o,{content:G}),ls(),(()=>{const s=v();return l(s,a(c,{type:"password"})),s})(),a(o,{content:J}),a(P,{get show(){return e()},tabs:n,onCancel:()=>p(!1)})]}b(["click"]);export{es as default};
