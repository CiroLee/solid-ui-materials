...
`,w=p("<div flex items-center justify-between><h3>SIcon</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),f=p("<span text-sub>based on"),y=p('<a text-14px text-blue-600 ml-1 href="https://github.com/Remix-Design/RemixIcon" target="-blank">Remixicon'),k=p("<h4>图标尺寸"),o=p('<div class="children:mr-2">'),_=p("<h4>图标颜色(支持渐变色)");function b(){const r=[{name:"tsx",path:"components/SIcon/index.tsx"},{name:"scss",path:"components/SIcon/index.scss"}],[h,t]=j(!1);return[(()=>{const s=w(),i=s.firstChild,e=i.nextSibling,m=e.firstChild;return m.$$click=()=>t(!0),n(e,a(d,{path:"SIcon",name:"source"}),null),s})(),f(),y(),k(),(()=>{const s=o();return n(s,a(l,{name:"home-smile-2-line"}),null),n(s,a(l,{name:"home-smile-2-line",size:"24px"}),null),n(s,a(l,{name:"home-smile-2-line",size:"32px"}),null),s})(),a(c,{html:x}),_(),(()=>{const s=o();return n(s,a(l,{name:"home-smile-2-fill",size:"32px",color:"blue"}),null),n(s,a(l,{name:"home-smile-2-fill",size:"32px",color:"red"}),null),n(s,a(l,{name:"home-smile-2-fill",size:"32px",gradient:"linear-gradient(45deg, yellow, green)"}),null),s})(),a(c,{html:q}),a(g,{get show(){return h()},tabs:r,onCancel:()=>t(!1)})]}u(["click"]);export{b as default};
