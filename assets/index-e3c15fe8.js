import{m as M,d as w,k,f as O,i as p,c as l,g as W,F as x,a as S,b as H,e as b,t as i,S as C}from"./index-10b63f6b.js";import{S as z}from"./index-7dc4df9d.js";import{S as v}from"./index-d592343d.js";import{S as F}from"./index-2583c958.js";import{C as D,a as P}from"./index-2d172113.js";class I{constructor(s){this.config=s}grid=42;generate(){const{month:s,year:t,startWeekOnSunday:u}=this.config,d=this.getFirstDayOfMonth(s,t),o=this.getDaysInMonth(s,t),m=u?d.getDay():(d.getDay()+6)%7,j=[];for(let g=0;g<this.grid;g++)j.push(new Date(t,s-1,1+(g-m)));return{list:j,total:o}}getFirstDayOfMonth(s,t){return new Date(t,s-1,1)}getDaysInMonth(s,t){return new Date(t,s,0).getDate()}}const L=i('<div><div class="s-calendar__week-bar"></div><div class="s-calendar__body">'),A=i("<li>"),B=i('<li class="s-calendar__body-item"><span>'),N=["日","一","二","三","四","五","六"],Y=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],E=r=>{const s=M({value:new Date,startWeekOnSunday:!0,language:"zh",class:"",style:{}},r),[t,u]=w(new Date),d=a=>{u(a),r.onChange?.(a)},o=a=>{const n=new Date(a.getFullYear(),a.getMonth(),a.getDate()),e=new Date(t().getFullYear(),t().getMonth(),t().getDate());return n.getTime()===e.getTime()},m=a=>a.getMonth()===s.value.getMonth()&&a.getFullYear()===s.value.getFullYear(),j=k(()=>{let a=s.language==="zh"?N:Y;if(!s.startWeekOnSunday){const n=[...a],e=n.shift();a=n.concat(e)}return a});O(()=>{u(s.value)});const g=k(()=>new I({month:s.value.getMonth()+1,year:s.value.getFullYear(),startWeekOnSunday:s.startWeekOnSunday}).generate());return(()=>{const a=L(),n=a.firstChild,e=n.nextSibling;return p(a,l(W,{get when(){return s.header},get children(){return s.header}}),n),p(n,l(x,{get each(){return j()},children:h=>(()=>{const c=A();return p(c,h),c})()})),p(e,l(x,{get each(){return g().list},children:h=>(()=>{const c=B(),q=c.firstChild;return c.$$click=()=>d(h),p(q,()=>h.getDate()),S(y=>{const f=!m(h),_=!!o(h);return f!==y._v$&&c.classList.toggle("not-current-month",y._v$=f),_!==y._v$2&&c.classList.toggle("active",y._v$2=_),y},{_v$:void 0,_v$2:void 0}),c})()})),S(()=>H(a,`s-calendar ${s.class}`.replace(/\s{2,}/g," ").trim())),a})()},$=E;b(["click"]);const T=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`;const V=i('<div class="custom-header"><span class="custom-header__date">'),Z=i("<div flex items-center justify-between><h3>SCalendar</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),G=i("<h4>basic"),J=i("<p>date: "),K=i("<h4>custom header"),Q=i('<div class="flex items-center mb-4"><span ml-3>startWeekOnSunday: '),U=r=>(()=>{const s=V(),t=s.firstChild;return p(s,l(v,{outline:!0,shape:"square",size:"tiny",type:"primary",get onClick(){return r.onPrevChange},get children(){return l(C,{name:"arrow-left-s-line",size:"20px"})}}),t),p(t,()=>r.value.toLocaleDateString()),p(s,l(v,{outline:!0,shape:"square",size:"tiny",type:"primary",get onClick(){return r.onNextChange},get children(){return l(C,{name:"arrow-right-s-line",size:"20px"})}}),null),s})();function es(){const r=[{name:"index.tsx",path:"components/SCalendar/index.tsx"},{name:"calendar.ts",path:"components/SCalendar/calendar.ts"},{name:"index.scss",path:"components/SCalendar/index.scss"}],[s,t]=w(!1),[u,d]=w(new Date),[o,m]=w(new Date("2023/7/1")),[j,g]=w(!0),a=n=>{const e=new Date(o());n==="prev"?e.setMonth(o().getMonth()-1):e.setMonth(o().getMonth()+1),m(e)};return[(()=>{const n=Z(),e=n.firstChild,h=e.nextSibling,c=h.firstChild;return c.$$click=()=>t(!0),p(h,l(F,{path:"SAlert",name:"source"}),null),n})(),G(),(()=>{const n=J();return n.firstChild,p(n,()=>u().toLocaleDateString(),null),n})(),l($,{class:"max-w-80%",get value(){return u()},onChange:d}),l(D,{content:T}),K(),(()=>{const n=Q(),e=n.firstChild;return e.firstChild,p(n,l(z,{get checked(){return j()},onChange:g}),e),p(e,()=>j()?"true":"false",null),n})(),l($,{class:"max-w-80%",get startWeekOnSunday(){return j()},language:"en",get header(){return l(U,{onPrevChange:()=>a("prev"),onNextChange:()=>a("next"),get value(){return o()}})},get value(){return o()},onChange:m}),l(D,{content:R}),l(P,{get show(){return s()},tabs:r,onCancel:()=>t(!1)})]}b(["click"]);export{es as default};
