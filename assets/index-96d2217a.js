import{m as z,d as i,f as V,g as L,i as t,c as a,h as d,S as o,a as C,b as B,s as P,j as I,e as A,t as p,A as W}from"./index-0fdfb4b1.js";import{S as D,C as h,a as E}from"./index-09b91603.js";const H=p('<div class="s-input__prefix">'),M=p('<div class="s-input__suffix">'),b=p('<div class="s-input__suffix s-input__clear">'),N=p('<span class="s-input__suffix s-input__count">'),O=p("<div><input>"),R=l=>{const r=z({size:"medium",countWidth:"0px",class:"",style:{}},l),[m,g]=i(""),[u,y]=i(!0),f=V(()=>l.type==="password"?u()?"password":"text":l.type||"text"),x=e=>{const s=e.target;if(l.maxLength&&s.value.length>l.maxLength){s.value=s.value.slice(0,l.maxLength);return}l.onChange&&l.onChange(s.value)};return L(()=>{l.showCount&&(l.maxLength?g(`${l.value?.length}/${l.maxLength}`):g(`${l.value?.length}`))}),(()=>{const e=O(),s=e.firstChild;return t(e,a(d,{get when(){return l.prefix},get children(){const n=H();return t(n,()=>l.prefix),n}}),s),s.$$input=x,t(e,a(d,{get when(){return l.suffix},get children(){const n=M();return t(n,()=>l.suffix),n}}),null),t(e,a(d,{get when(){return l.clearable&&l.value},get children(){const n=b();return n.$$click=()=>l.onChange?.(""),t(n,a(o,{name:"close-circle-fill"})),n}}),null),t(e,a(d,{get when(){return l.showCount},get children(){const n=N();return t(n,m),n}}),null),t(e,a(d,{get when(){return l.type==="password"},get children(){const n=b();return n.$$click=()=>y(!u()),t(n,a(o,{get name(){return`${u()?"eye-close-line":"eye-line"}`}})),n}}),null),C(n=>{const j=`s-input s-input--${r.size} ${r.status?`s-input--${r.status}`:""} 
      ${r.class}`.replace(/\s{2,}/g," ").trim(),w={...r.style,"--count-width":r.countWidth},k=f(),$=l.disabled,q=l.readonly,S=l.placeholder;return j!==n._v$&&B(e,n._v$=j),n._v$2=P(e,w,n._v$2),k!==n._v$3&&I(s,"type",n._v$3=k),$!==n._v$4&&(s.disabled=n._v$4=$),q!==n._v$5&&(s.readOnly=n._v$5=q),S!==n._v$6&&I(s,"placeholder",n._v$6=S),n},{_v$:void 0,_v$2:void 0,_v$3:void 0,_v$4:void 0,_v$5:void 0,_v$6:void 0}),C(()=>s.value=l.value||""),e})()},c=R;A(["input","click"]);const T=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span>, createSignal } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`,X=p("<div flex items-center justify-between><h3>SInput</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),Y=p("<p text-gray>depend on "),Z=p("<h4>基本使用"),ss=p("<div w-540px><p>value: "),as=p("<h4>不同尺寸"),_=p("<div w-540px children:mb-3>"),ns=p("<h4>前缀和后缀"),ls=p("<h4>不同状态"),ts=p("<h4>可清除"),v=p("<div w-540px>"),ps=p("<h4>显示计数"),es=p("<h4>密码");function os(){const l=[{name:"tsx",path:"components/SInput/index.tsx"},{name:"scss",path:"components/SInput/index.scss"}],[r,m]=i(""),[g,u]=i(""),[y,f]=i(""),[x,e]=i(!1);return[(()=>{const s=X(),n=s.firstChild,j=n.nextSibling,w=j.firstChild;return w.$$click=()=>e(!0),t(j,a(D,{path:"SIcon",name:"source"}),null),s})(),(()=>{const s=Y();return s.firstChild,t(s,a(W,{class:"text-blue decoration-none",activeClass:"text-blue-600",inactiveClass:"text-blue-600",href:"/components/icon",children:"SIcon"}),null),s})(),Z(),(()=>{const s=ss(),n=s.firstChild;return n.firstChild,t(n,r,null),t(s,a(c,{get value(){return r()},placeholder:"input sth...",onChange:m}),null),s})(),a(h,{content:T}),as(),(()=>{const s=_();return t(s,a(c,{size:"small",placeholder:"small size"}),null),t(s,a(c,{size:"medium",placeholder:"medium size"}),null),t(s,a(c,{size:"large",placeholder:"large size"}),null),s})(),a(h,{content:F}),ns(),(()=>{const s=_();return t(s,a(c,{placeholder:"prefix icon",get prefix(){return a(o,{name:"user-line",color:"gray"})}}),null),t(s,a(c,{placeholder:"suffix icon",get suffix(){return a(o,{name:"search-line",color:"gray"})}}),null),t(s,a(c,{placeholder:"suffix icon",get prefix(){return a(o,{name:"money-cny-box-line",color:"gray"})},get suffix(){return a(o,{name:"information-line",color:"#b9b5b5",title:"information"})}}),null),s})(),a(h,{content:G}),ls(),(()=>{const s=_();return t(s,a(c,{status:"warn",placeholder:"warn",get prefix(){return a(o,{name:"shield-keyhole-line"})}}),null),t(s,a(c,{status:"error",placeholder:"error",get prefix(){return a(o,{name:"shield-keyhole-line"})}}),null),t(s,a(c,{disabled:!0,placeholder:"disabled",status:"error",value:"disabled",get prefix(){return a(o,{name:"shield-keyhole-line",color:"#BABABA"})}}),null),t(s,a(c,{readonly:!0,value:"readonly"}),null),s})(),a(h,{content:J}),ts(),(()=>{const s=v();return t(s,a(c,{clearable:!0,placeholder:"input sth...",get value(){return g()},onChange:u})),s})(),a(h,{content:K}),ps(),(()=>{const s=v();return t(s,a(c,{showCount:!0,placeholder:"input sth...",maxLength:20,countWidth:"40px",get value(){return y()},onChange:f})),s})(),a(h,{content:Q}),es(),(()=>{const s=v();return t(s,a(c,{type:"password"})),s})(),a(h,{content:U}),a(E,{get show(){return x()},tabs:l,onCancel:()=>e(!1)})]}A(["click"]);export{os as default};
