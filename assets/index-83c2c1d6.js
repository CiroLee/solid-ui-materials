import{m as k,d as u,i as m,c as s,a as y,F as b,b as _,e as w,t as a,S as g}from"./index-b8edd375.js";import{S as f,C as d,a as $}from"./index-e662508b.js";const v=a("<div>"),S=a('<div class="s-tabs__item">'),C=c=>{const r=k({class:"",style:{}},c),[j,o]=u(c.defaultKey),i=n=>{n.disabled||(o(n.key),c.onChange?.(n.key))};return(()=>{const n=v();return m(n,s(b,{get each(){return c.tabs},children:l=>(()=>{const p=S();return p.$$click=()=>i(l),m(p,()=>l.content),y(t=>{const e=l.key===j(),h=!!l.disabled;return e!==t._v$&&p.classList.toggle("s-tabs__item--active",t._v$=e),h!==t._v$2&&p.classList.toggle("s-tabs__item--disabled",t._v$2=h),t},{_v$:void 0,_v$2:void 0}),p})()})),y(()=>_(n,`s-tabs ${r.class}`.replace(/\s{2,}/g," ").trim())),n})()},x=C;w(["click"]);const T=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
