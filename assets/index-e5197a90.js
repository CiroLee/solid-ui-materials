...
`;const V=i('<div class="custom-header"><span class="custom-header__date">'),Z=i("<div flex items-center justify-between><h3>SCalendar</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),G=i("<h4>basic"),J=i("<p>date: "),K=i("<h4>custom header"),Q=i('<div class="flex items-center mb-4"><span ml-3>startWeekOnSunday: '),U=r=>(()=>{const s=V(),t=s.firstChild;return p(s,l(D,{outline:!0,shape:"square",size:"tiny",type:"primary",get onClick(){return r.onPrevChange},get children(){return l(C,{name:"arrow-left-s-line",size:"20px"})}}),t),p(t,()=>r.value.toLocaleDateString()),p(s,l(D,{outline:!0,shape:"square",size:"tiny",type:"primary",get onClick(){return r.onNextChange},get children(){return l(C,{name:"arrow-right-s-line",size:"20px"})}}),null),s})();function ts(){const r=[{name:"index.tsx",path:"components/SCalendar/index.tsx"},{name:"calendar.ts",path:"components/SCalendar/calendar.ts"},{name:"index.scss",path:"components/SCalendar/index.scss"}],[s,t]=w(!1),[u,d]=w(new Date),[o,m]=w(new Date("2023/7/1")),[j,g]=w(!0),a=n=>{const e=new Date(o());n==="prev"?e.setMonth(o().getMonth()-1):e.setMonth(o().getMonth()+1),m(e)};return[(()=>{const n=Z(),e=n.firstChild,h=e.nextSibling,c=h.firstChild;return c.$$click=()=>t(!0),p(h,l(P,{path:"SAlert",name:"source"}),null),n})(),G(),(()=>{const n=J();return n.firstChild,p(n,()=>u().toLocaleDateString(),null),n})(),l($,{class:"max-w-80%",get value(){return u()},onChange:d}),l(v,{content:T}),K(),(()=>{const n=Q(),e=n.firstChild;return e.firstChild,p(n,l(z,{get checked(){return j()},onChange:g}),e),p(e,()=>j()?"true":"false",null),n})(),l($,{class:"max-w-80%",get startWeekOnSunday(){return j()},language:"en",get header(){return l(U,{onPrevChange:()=>a("prev"),onNextChange:()=>a("next"),get value(){return o()}})},get value(){return o()},onChange:m}),l(v,{content:R}),l(F,{get show(){return s()},tabs:r,onCancel:()=>t(!1)})]}b(["click"]);export{ts as default};
