import{d as j,i as n,c as a,A as u,S as l,t as p,e as g}from"./index-10b63f6b.js";import{C as c,a as d}from"./index-2d172113.js";import{S as x}from"./index-2583c958.js";const q=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
`,f=p("<div flex items-center justify-between><h3>SIcon</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),y=p("<span text-sub>icon based on"),k=p("<h4>size"),o=p('<div class="children:mr-2">'),_=p("<h4>color(support gradient)");function C(){const r=[{name:"index.tsx",path:"components/SIcon/index.tsx"},{name:"index.scss",path:"components/SIcon/index.scss"}],[h,t]=j(!1);return[(()=>{const s=f(),i=s.firstChild,e=i.nextSibling,m=e.firstChild;return m.$$click=()=>t(!0),n(e,a(x,{path:"SIcon",name:"source"}),null),s})(),y(),a(u,{class:"text-blue-600 ml-1",href:"https://github.com/Remix-Design/RemixIcon",target:"_blank",children:"Remixicon"}),k(),(()=>{const s=o();return n(s,a(l,{name:"home-smile-2-line"}),null),n(s,a(l,{name:"home-smile-2-line",size:"24px"}),null),n(s,a(l,{name:"home-smile-2-line",size:"32px"}),null),s})(),a(c,{content:q}),_(),(()=>{const s=o();return n(s,a(l,{name:"home-smile-2-fill",size:"32px",color:"blue"}),null),n(s,a(l,{name:"home-smile-2-fill",size:"32px",color:"red"}),null),n(s,a(l,{name:"home-smile-2-fill",size:"32px",gradient:"linear-gradient(45deg, yellow, green)"}),null),s})(),a(c,{content:w}),a(d,{get show(){return h()},tabs:r,onCancel:()=>t(!1)})]}g(["click"]);export{C as default};
