import{d as y,i as n,c as a,S as e,t as p,e as S}from"./index-10b63f6b.js";import{S as b}from"./index-2583c958.js";import{S as l}from"./index-d592343d.js";import{C as c,a as x}from"./index-2d172113.js";const w=`<pre class="hljs"><code><span class="hljs-keyword">import</span> { <span class="hljs-keyword">type</span> <span class="hljs-title class_">Component</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;solid-js&#x27;</span>;
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">outline</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;primary&quot;</span>&gt;</span>
        primary
      <span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">outline</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;success&quot;</span>&gt;</span>
        success
      <span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">outline</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;warn&quot;</span>&gt;</span>
        warn
      <span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">outline</span> <span class="hljs-attr">type</span>=<span class="hljs-string">&quot;danger&quot;</span>&gt;</span>
        danger
      <span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;tiny&quot;</span>&gt;</span>tiny<span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">shape</span>=<span class="hljs-string">&quot;square&quot;</span>&gt;</span>S<span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
...
<span class="hljs-keyword">const</span> <span class="hljs-title class_">App</span>: <span class="hljs-title class_">Component</span> = <span class="hljs-function">() =&gt;</span> {
  <span class="hljs-keyword">return</span> (
    <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">SButton</span> <span class="hljs-attr">outline</span> <span class="hljs-attr">block</span>&gt;</span>
        block
      <span class="hljs-tag">&lt;/<span class="hljs-name">SButton</span>&gt;</span>
...
`;const v=p("<div flex items-center justify-between><h3>SButton</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),C=p("<h4>button type"),j=p('<div class="children:mr-2 children:mb-2">'),A=p("<h4>outline"),z=p("<h4>size"),r=p('<div class="flex items-center children:mr-2 children:mb-2">'),P=p("<h4>shape"),I=p("<h4>block"),D=p("<div w-400px p-12px border border-solid border-gray-300 rounded children:mb-2>"),E=p("<h4>usage - button group"),u=p('<div class="button-group">'),L=p("<h4>usage - button with icon"),i=p("<span>Add"),V=p("<span>loading");function K(){const g=[{name:"index.tsx",path:"components/SButton/index.tsx"},{name:"index.scss",path:"components/SButton/index.scss"}],[d,h]=y(!1);return[(()=>{const s=v(),t=s.firstChild,o=t.nextSibling,m=o.firstChild;return m.$$click=()=>h(!0),n(o,a(b,{path:"SButton",name:"source"}),null),s})(),C(),(()=>{const s=j();return n(s,a(l,{type:"primary",children:"primary"}),null),n(s,a(l,{type:"success",children:"success"}),null),n(s,a(l,{type:"warn",children:"warn"}),null),n(s,a(l,{type:"danger",children:"danger"}),null),n(s,a(l,{type:"text",children:"text"}),null),n(s,a(l,{disabled:!0,children:"primary"}),null),s})(),a(c,{content:w}),A(),(()=>{const s=j();return n(s,a(l,{outline:!0,type:"primary",children:"primary"}),null),n(s,a(l,{outline:!0,type:"success",children:"success"}),null),n(s,a(l,{outline:!0,type:"warn",children:"warn"}),null),n(s,a(l,{outline:!0,type:"danger",children:"danger"}),null),s})(),a(c,{content:k}),z(),(()=>{const s=r();return n(s,a(l,{size:"tiny",children:"tiny"}),null),n(s,a(l,{size:"small",children:"small"}),null),n(s,a(l,{size:"medium",children:"medium"}),null),n(s,a(l,{size:"large",children:"large"}),null),s})(),a(c,{content:q}),P(),(()=>{const s=r();return n(s,a(l,{shape:"default",children:"default"}),null),n(s,a(l,{shape:"round",children:"round"}),null),n(s,a(l,{shape:"circle",children:"C"}),null),n(s,a(l,{shape:"square",children:"S"}),null),s})(),a(c,{content:B}),I(),(()=>{const s=D();return n(s,a(l,{outline:!0,block:!0,children:"block"}),null),n(s,a(l,{block:!0,type:"primary",children:"block"}),null),n(s,a(l,{block:!0,shape:"round",type:"primary",children:"block"}),null),s})(),a(c,{content:_}),E(),(()=>{const s=u();return n(s,a(l,{type:"primary",children:"apple"}),null),n(s,a(l,{type:"primary",children:"pear"}),null),n(s,a(l,{type:"primary",children:"banana"}),null),s})(),(()=>{const s=u();return n(s,a(l,{type:"primary",shape:"round",children:"apple"}),null),n(s,a(l,{type:"primary",shape:"round",children:"pear"}),null),n(s,a(l,{type:"primary",shape:"round",children:"banana"}),null),s})(),a(c,{content:f}),L(),(()=>{const s=r();return n(s,a(l,{type:"primary",get children(){return[a(e,{name:"add-circle-line",size:"16px"}),(()=>{const t=i();return t.style.setProperty("padding-left","4px"),t})()]}}),null),n(s,a(l,{type:"primary",get children(){return[(()=>{const t=i();return t.style.setProperty("padding-right","4px"),t})(),a(e,{name:"add-circle-line",size:"16px"})]}}),null),n(s,a(l,{type:"primary",loading:!0,class:"button-loading",get children(){return[a(e,{name:"loader-line",size:"16px"}),(()=>{const t=V();return t.style.setProperty("padding-left","4px"),t})()]}}),null),s})(),a(c,{content:$}),a(x,{get show(){return d()},tabs:g,onCancel:()=>h(!1)})]}S(["click"]);export{K as default};
