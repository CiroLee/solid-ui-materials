import{m as b,i as n,c as x,a as k,s as S,e as m,t as p,b as w,d as a,S as u}from"./index-5d6db1ad.js";import{S as _,C as r,a as B}from"./index-db029510.js";const q=p('<button tabindex="0">'),f=e=>{const c=b({size:"medium",type:"default",class:"",style:{}},e),o=()=>{e.onClick&&e.onClick()};return(()=>{const s=q();return s.$$click=o,n(s,()=>e.children),x(t=>{const h=e.disabled,j=`s-button s-button--${c.size} s-button--${c.type}
...
`;const I=p("<div flex items-center justify-between><h3>SButton</h3><div><span hover:text-blue-600 text-gray cursor-pointer mr-4>code"),D=p("<h4>按钮类型"),E=p('<div class="children:mr-2 children:mb-2">'),H=p("<h4>按钮尺寸"),i=p('<div class="flex items-center children:mr-2 children:mb-2">'),L=p("<h4>按钮形状"),N=p("<h4>block按钮"),R=p("<div w-400px p-12px border border-solid border-gray-300 rounded children:mb-2>"),V=p("<h4>应用-按钮组"),g=p('<div class="button-group">'),F=p("<h4>应用-带有图标按钮"),d=p("<span>Add"),G=p("<span>loading");function M(){const e=[{name:"tsx",path:"components/SButton/index.tsx"},{name:"scss",path:"components/SButton/index.scss"}],[c,o]=w(!1);return[(()=>{const s=I(),t=s.firstChild,h=t.nextSibling,j=h.firstChild;return j.$$click=()=>o(!0),n(h,a(_,{path:"SButton",name:"source"}),null),s})(),D(),(()=>{const s=E();return n(s,a(l,{type:"default",children:"default"}),null),n(s,a(l,{type:"primary",children:"primary"}),null),n(s,a(l,{type:"success",children:"success"}),null),n(s,a(l,{type:"warn",children:"warn"}),null),n(s,a(l,{type:"danger",children:"danger"}),null),n(s,a(l,{type:"text",children:"text"}),null),n(s,a(l,{disabled:!0,children:"primary"}),null),s})(),a(r,{content:$}),H(),(()=>{const s=i();return n(s,a(l,{size:"small",children:"small"}),null),n(s,a(l,{size:"medium",children:"medium"}),null),n(s,a(l,{size:"large",children:"large"}),null),s})(),a(r,{content:v}),L(),(()=>{const s=i();return n(s,a(l,{round:!0,children:"round"}),null),n(s,a(l,{circle:!0,children:"C"}),null),s})(),a(r,{content:C}),N(),(()=>{const s=R();return n(s,a(l,{block:!0,children:"block"}),null),n(s,a(l,{block:!0,type:"primary",children:"block"}),null),n(s,a(l,{block:!0,round:!0,type:"primary",children:"block"}),null),s})(),a(r,{content:A}),V(),(()=>{const s=g();return n(s,a(l,{type:"primary",children:"apple"}),null),n(s,a(l,{type:"primary",children:"pear"}),null),n(s,a(l,{type:"primary",children:"banana"}),null),s})(),(()=>{const s=g();return n(s,a(l,{type:"primary",round:!0,children:"apple"}),null),n(s,a(l,{type:"primary",round:!0,children:"pear"}),null),n(s,a(l,{type:"primary",round:!0,children:"banana"}),null),s})(),a(r,{content:z}),F(),(()=>{const s=i();return n(s,a(l,{type:"primary",get children(){return[a(u,{name:"add-circle-line",size:"16px"}),(()=>{const t=d();return t.style.setProperty("padding-left","4px"),t})()]}}),null),n(s,a(l,{type:"primary",get children(){return[(()=>{const t=d();return t.style.setProperty("padding-right","4px"),t})(),a(u,{name:"add-circle-line",size:"16px"})]}}),null),n(s,a(l,{type:"primary",loading:!0,class:"button-loading",get children(){return[a(u,{name:"loader-line",size:"16px"}),(()=>{const t=G();return t.style.setProperty("padding-left","4px"),t})()]}}),null),s})(),a(r,{content:P}),a(B,{get show(){return c()},tabs:e,onCancel:()=>o(!1)})]}m(["click"]);export{M as default};
